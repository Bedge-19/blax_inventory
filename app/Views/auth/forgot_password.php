...
<div class="text-center mb-md">
    ...
    <p class="text-title-lg text-on-surface-variant font-medium">Forgot Password</p>
    <p class="text-label-sm text-outline mt-xs">Enter your registered email address and we'll send you a password reset link.</p>
</div>
...
<form class="flex flex-col gap-md" action="<?= base_url('forgot-password') ?>" method="POST">
    ...
    <button class="w-full bg-primary hover:bg-primary-container text-on-primary font-button text-button rounded py-md mt-md shadow-lg hover:shadow-xl hover:-translate-y-[2px] transition-all duration-200 uppercase tracking-wider" type="submit">Send Reset Link</button>
</form>
