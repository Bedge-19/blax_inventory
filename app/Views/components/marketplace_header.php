    ...
    <div class="flex items-center gap-md">
        ...
        <div class="flex items-center gap-sm">
            ...
            <div class="relative block">
                ...
                <div id="notif-dropdown" class="hidden absolute right-0 top-full mt-2 w-80 max-w-[calc(100vw-1.5rem)] bg-surface-container-lowest rounded-2xl shadow-2xl border border-outline-variant/30 py-2 z-50 origin-top-right">
        ...
        <div class="flex items-center gap-xs sm:gap-sm pl-2 sm:pl-md border-l border-outline-variant/30 relative">
            ...
            <?php if ($isLogged): ?>
                ...
                <div class="relative">
                    ...
                    <!-- Profile Dropdown -->
                    <div id="profile-dropdown" class="dropdown-menu absolute right-0 top-full mt-2 w-64 max-w-[calc(100vw-1.5rem)] bg-surface-container-lowest rounded-2xl shadow-2xl border border-outline-variant/30 py-2 z-50 origin-top-right">
