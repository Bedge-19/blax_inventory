            ...
            <header class="sticky top-0 z-30 bg-surface-container-lowest/80 backdrop-blur-xl border-b border-outline-variant/30 px-4 md:px-8 py-2.5 flex justify-between items-center transition-all">
                ...
                <div class="flex items-center gap-2.5 sm:gap-3.5">
                    ...
                    <div class="relative">
                        ...
                        <div id="notif-panel" class="hidden absolute right-0 top-full mt-2 w-80 max-w-[calc(100vw-1.5rem)] bg-surface-container-lowest rounded-2xl shadow-2xl border border-outline-variant/30 z-50 overflow-hidden origin-top-right">
                    ...
                    <div class="flex items-center gap-sm relative">
                        ...
                        <div id="tenant-profile-dropdown" class="dropdown-menu absolute right-0 top-full mt-2 w-56 max-w-[calc(100vw-1.5rem)] bg-surface-container-lowest rounded-2xl shadow-2xl border border-outline-variant/30 p-2 z-50 origin-top-right">
